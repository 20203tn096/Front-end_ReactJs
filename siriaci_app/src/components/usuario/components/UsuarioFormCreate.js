...
export const UsuarioFormCreate = ({ isOpenCreate, onClose, aspectos }) => {
    ...
    return (
        <Modal show={isOpenCreate} onHide={handleClose}>
                    ...
                    <Row>
                        <Form.Group >
                            <Col className='text-end'>
                                ...
                                <Button variant='success' className='me-3' type='submit'> <FeatherIcon icon={"plus"} /> Registrar</Button>
                            </Col>
                        </Form.Group>
                    </Row>
                </Modal.Footer>
